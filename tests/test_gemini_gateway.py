...
def test_google_auth_inheritance_failure(mock_shell, mock_fs):
...
@pytest.mark.asyncio
async def test_validate_binary_not_found(mock_shell, mock_fs):
    adapter = GeminiCLIAdapter(mock_shell, mock_fs, binary_path="/wrong/path")
